...
const CompAdd = () => {
  ...
  const fnSubmitHandler = function (e) {
    ...
    if (ddayStamp < nowStamp || (ddayStamp - nowStamp) / (24 * 60 * 60) > 300) {
      //과거이거나 미래인경우
      _setDate('');
      _setTime('00:00');
      return false;
  ...
  return (
    ...
    >
      <p>
        <label htmlFor='input-id1'>
          <i className='fa-solid fa-pencil'></i> DDay Title
        </label>
        <input
          id='input-id1'
          required
          ...
          type='text'
          placeholder='dday 일정명을 입력해 주세요'
          value={_title}
        />
      </p>
      <p>
        <label htmlFor='input-id2'>
          <i className='fa-regular fa-calendar'></i> DDay Date
        </label>
        <input
          id='input-id2'
          required
      ...
      <p>
        <label htmlFor='input-id3'>
          <i className='fa-regular fa-clock'></i> DDay Time
        </label>
        <input
          id='input-id3'
          required
