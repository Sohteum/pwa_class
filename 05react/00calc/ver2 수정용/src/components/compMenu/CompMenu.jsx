...
const CompMenu = () => {
  ...
  return (
    <section className='menu'>
      <img
        className='circle'
        src={require('../../assets/img/main_bg.png')}
        alt=''
      />
      ...
      <form className='theme'>
        <fieldset>
          <legend>
            {' '}
            <i className='fa-solid fa-palette'></i>choice app Theme
          </legend>
          <div>
            <input
              key={_key}
          ...
          {/* 키가 안바뀌면 갱신이 안됨. 그래서 유즈이팩트안에서 바꿔주는거 */}
        </fieldset>
      </form>
      <nav>
        <Link to='/calc'>
        ...
        <Link to='/bmi'>
          <i className='fa-solid fa-weight-scale'></i> bmi
        </Link>
        <Link to='/dday'>
          <i className='fa-solid fa-calendar-days'></i> dday
        </Link>
      </nav>
