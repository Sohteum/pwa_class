...
const CompLi = ({ i }) => {
  ...
  const {
    _pointArr, _setPointArr, fnChangePoint, _readOnly, _setReadOnly, _setShowBtn, _setNewColor, _newColor
  ...
  function fnOnInputHandler(e) {
    ...
    _setNewColor((fnChangePoint(pointArr) === 3) ? ' #CCC' : '#FFF')
  }
  ...
  return (
    <li>
      ...
      <span>{_num2}</span>
      =
      <input onInput={fnOnInputHandler} type="number" min="0" max="9" readOnly={_readOnly} style={{ backgroundColor: _newColor }} />
    </li>
  );
};
