  ...
  return (
    <form onSubmit={fnSubmitHandler} >
      <fieldset>
        ...
        <p>
          <input onChange={fnChangeHandler} value={1} checked={_chkObj[1]} type="radio" name='radio1' />라디오1 {/* 여기 이렇게 불리언값넣어두면 평생안변해 스테이트 만들어 */}
          <input onChange={fnChangeHandler} value={2} checked={_chkObj[2]} type="radio" name='radio1' />라디오2{/* 여기서 왜 []이거써? _chkObj.1 이런것 못써 */}
