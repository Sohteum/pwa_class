...
<head>
  ...
  <link rel="stylesheet" href=" <?php bloginfo('template_directory'); ?>/css/page-introduce.css">
  ...
  <link rel="stylesheet" href=" <?php bloginfo('template_directory'); ?>/css/carousel_3d.css">
  ...
  <script src="<?php bloginfo('template_directory'); ?>/js/jquery.ripples.js"></script>
