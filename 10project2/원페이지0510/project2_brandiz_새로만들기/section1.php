<section class="section1">
  <figure class="bg">
    <img src="./img/section1/section1-block.jpg" alt="">
  </figure>
  <figure class="papers">
    <!-- 물방울을 랜덤하게 넣을 예정 -->
    <script>
  ...
  <div class="desc">
    <figure class=title>
      <img class="deco1" src="./img/section1/section1_heart.png" alt="">
      <?php include "img/svg/section1-text.php" ?>
      <img class="deco2" src="./img/section1/section1_peach.png" alt="">
    </figure>
    <figure class="slogun">
