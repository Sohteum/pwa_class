...
}//무조건 문자열로 들어간다. 배열은 들어갈 수 없음. 그래서 제이슨형테로   집어넣음 이때는 무조건 스트링기파이
let arr = JSON.parse(localStorage.getItem(`arr`)) //무조건 문자열로 들어간다. 배열은 들어갈 수 없음. 그래서 제이슨형테로   집어넣음 이때는 무조건 스트링기파이
